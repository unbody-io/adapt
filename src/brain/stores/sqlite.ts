...
export class SQLiteBrainStore implements BrainStore {
	...
	internalLearners: SQLiteBrainCollection<BrainLearnerRecord>
	...
	constructor(path: string = ':memory:') {
		...
		`)
		this.db.exec(`
			CREATE TABLE IF NOT EXISTS internal_learners (
				id TEXT PRIMARY KEY,
				type TEXT NOT NULL
			)
		`)
		...
		this.internalLearners = new SQLiteBrainCollection<BrainLearnerRecord>(
			this.db,
			'internal_learners',
			learnersColumns,
		)
