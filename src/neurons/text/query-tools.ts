/**
 * Text-neuron query tools
 *
 * Provides the readUnderstanding tool (closes over neuron state)
...
/**
 * Create a readUnderstanding tool that closes over neuron state
 *
...
/**
 * Build the query prompt for text-based neurons
 */
